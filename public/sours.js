parcelRequire = function(e, r, t, n) {
  ...
  'iSxC': [function(require, module, exports) {
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.extractVersion = o, exports.wrapPeerConnectionEvent = i, exports.disableLog = s, exports.disableWarnings = a, exports.log = p, exports.deprecated = u, exports.detectBrowser = c, exports.compactObject = f, exports.walkStats = l, exports.filterStats = v;
    var n = !0,
      r = !0;
    ...
    function i(e, t, n) {
      if (e.RTCPeerConnection) {
        ...
        r.addEventListener = function(e, r) {
          ...
          return this._eventMap = this._eventMap || {}, this._eventMap[t] || (this._eventMap[t] = new Map), this._eventMap[t].set(r, i), o.apply(this, [e, i]);
        };
        var i = r.removeEventListener;
        r.removeEventListener = function(e, n) { if (e !== t || !this._eventMap || !this._eventMap[t]) return i.apply(this, arguments); if (!this._eventMap[t].has(n)) return i.apply(this, arguments); var r = this._eventMap[t].get(n); return this._eventMap[t].delete(n), 0 === this._eventMap[t].size && delete this._eventMap[t], 0 === Object.keys(this._eventMap).length && delete this._eventMap, i.apply(this, [e, r]); }, Object.defineProperty(r, 'on' + t, { get: function() { return this['_on' + t]; }, set: function(e) { this['_on' + t] && (this.removeEventListener(t, this['_on' + t]), delete this['_on' + t]), e && this.addEventListener(t, this['_on' + t] = e); }, enumerable: !0, configurable: !0 });
      }
    }
    ...
    function p() { if ('object' === ('undefined' == typeof window ? 'undefined' : t(window))) { if (n) return; 'undefined' != typeof console && 'function' == typeof console.log && console.log.apply(console, arguments); } }

    function u(e, t) { r && console.warn(e + ' is deprecated, please use ' + t + ' instead.'); }
    ...
    function d(e) { return '[object Object]' === Object.prototype.toString.call(e); }
          ...
          a = function(e, a) {
            ...
            if (e && 'object' === o(e.video)) {
              ...
              if (d && ('user' === d.exact || 'environment' === d.exact || 'user' === d.ideal || 'environment' === d.ideal) && (!t.mediaDevices.getSupportedConstraints || !t.mediaDevices.getSupportedConstraints().facingMode || s))
                if (delete e.video.facingMode, 'environment' === d.exact || 'environment' === d.ideal ? u = ['back', 'rear'] : 'user' !== d.exact && 'user' !== d.ideal || (u = ['front']), u) return t.mediaDevices.enumerateDevices().then(function(r) { var t = (r = r.filter(function(e) { return 'videoinput' === e.kind; })).find(function(e) { return u.some(function(r) { return e.label.toLowerCase().includes(r); }); }); return !t && r.length && u.includes('back') && (t = r[r.length - 1]), t && (e.video.deviceId = d.exact ? { exact: t.deviceId } : { ideal: t.deviceId }), e.video = i(e.video), n('chrome: ' + JSON.stringify(e)), a(e); });
              e.video = i(e.video);
            }
            return n('chrome: ' + JSON.stringify(e)), a(e);
          },
          c = function(e) { return r.version >= 64 ? e : { name: { PermissionDeniedError: 'NotAllowedError', PermissionDismissedError: 'NotAllowedError', InvalidStateError: 'NotAllowedError', DevicesNotFoundError: 'NotFoundError', ConstraintNotSatisfiedError: 'OverconstrainedError', TrackStartError: 'NotReadableError', MediaDeviceFailedDueToShutdown: 'NotAllowedError', MediaDeviceKillSwitchOn: 'NotAllowedError', TabCaptureError: 'AbortError', ScreenCaptureError: 'AbortError', DeviceCaptureError: 'AbortError' }[e.name] || e.name, message: e.message, constraint: e.constraint || e.constraintName, toString: function() { return this.name + (this.message && ': ') + this.message; } }; };
        if (t.getUserMedia = function(e, r, o) { a(e, function(e) { t.webkitGetUserMedia(e, r, function(e) { o && o(c(e)); }); }); }.bind(t), t.mediaDevices.getUserMedia) {
          var d = t.mediaDevices.getUserMedia.bind(t.mediaDevices);
          t.mediaDevices.getUserMedia = function(e) { return a(e, function(e) { return d(e).then(function(r) { if (e.audio && !r.getAudioTracks().length || e.video && !r.getVideoTracks().length) throw r.getTracks().forEach(function(e) { e.stop(); }), new DOMException('', 'NotFoundError'); return r; }, function(e) { return Promise.reject(c(e)); }); }); };
        }
      }
    }
  }, { '../utils.js': 'iSxC' }],
  ...
  'uI5X': [function(require, module, exports) {
    ...
    function m(e, t) {
      if (e.RTCPeerConnection) {
        ...
        e.RTCPeerConnection.prototype.addStream = function(t) {
          var r = this;
          if (this._streams = this._streams || {}, this._reverseStreams = this._reverseStreams || {}, t.getTracks().forEach(function(e) { if (r.getSenders().find(function(t) { return t.track === e; })) throw new DOMException('Track already exists.', 'InvalidAccessError'); }), !this._reverseStreams[t.id]) {
        ...
        e.RTCPeerConnection.prototype.removeStream = function(e) { this._streams = this._streams || {}, this._reverseStreams = this._reverseStreams || {}, i.apply(this, [this._streams[e.id] || e]), delete this._reverseStreams[this._streams[e.id] ? this._streams[e.id].id : e.id], delete this._streams[e.id]; }, e.RTCPeerConnection.prototype.addTrack = function(t, r) {
          var n = this;
          ...
          if (this.getSenders().find(function(e) { return e.track === t; })) throw new DOMException('Track already exists.', 'InvalidAccessError');
          this._streams = this._streams || {}, this._reverseStreams = this._reverseStreams || {};
          var o = this._streams[r.id];
          if (o) o.addTrack(t), Promise.resolve().then(function() { n.dispatchEvent(new Event('negotiationneeded')); });
          else {
          ...
          var r = e.RTCPeerConnection.prototype[t],
            n = o({}, t, function() {
              ...
              return arguments.length && 'function' == typeof arguments[0] ? r.apply(this, [function(r) {
                var n = c(e, r);
                t[0].apply(null, [n]);
              }, function(e) { t[1] && t[1].apply(null, e); }, arguments[2]]) : r.apply(this, arguments).then(function(t) { return c(e, t); });
            });
        ...
        e.RTCPeerConnection.prototype.setLocalDescription = function() {
          ...
          }), new RTCSessionDescription({ type: t.type, sdp: r })), s.apply(this, arguments)) : s.apply(this, arguments);
          var e, t, r;
        };
        var a = Object.getOwnPropertyDescriptor(e.RTCPeerConnection.prototype, 'localDescription');
        Object.defineProperty(e.RTCPeerConnection.prototype, 'localDescription', { get: function() { var e = a.get.apply(this); return '' === e.type ? e : c(this, e); } }), e.RTCPeerConnection.prototype.removeTrack = function(e) {
          var t, r = this;
          if ('closed' === this.signalingState) throw new DOMException('The RTCPeerConnection\'s signalingState is \'closed\'.', 'InvalidStateError');
    ...
    function u(e, t) {
      !e.RTCPeerConnection && e.webkitRTCPeerConnection && (e.RTCPeerConnection = e.webkitRTCPeerConnection), e.RTCPeerConnection && t.version < 53 && ['setLocalDescription', 'setRemoteDescription', 'addIceCandidate'].forEach(function(t) {
        var r = e.RTCPeerConnection.prototype[t],
          n = o({}, t, function() { return arguments[0] = new('addIceCandidate' === t ? e.RTCIceCandidate : e.RTCSessionDescription)(arguments[0]), r.apply(this, arguments); });
        e.RTCPeerConnection.prototype[t] = n[t];
      });
    }

    function l(t, r) { e.wrapPeerConnectionEvent(t, 'negotiationneeded', function(e) { var t = e.target; if (!(r.version < 72 || t.getConfiguration && 'plan-b' === t.getConfiguration().sdpSemantics) || 'stable' === t.signalingState) return e; }); }
  ...
  'YHvh': [function(require, module, exports) {
    ...
    r.localCName = r.generateIdentifier(), r.splitLines = function(r) { return r.trim().split('\n').map(function(r) { return r.trim(); }); }, r.splitSections = function(r) { return r.split('\nm=').map(function(r, e) { return (e > 0 ? 'm=' + r : r).trim() + '\r\n'; }); }, r.getDescription = function(e) { var t = r.splitSections(e); return t && t[0]; }, r.getMediaSections = function(e) { var t = r.splitSections(e); return t.shift(), t; }, r.matchPrefix = function(e, t) { return r.splitLines(e).filter(function(r) { return 0 === r.indexOf(t); }); }, r.parseCandidate = function(r) {
      for (var e, t = { foundation: (e = 0 === r.indexOf('a=candidate:') ? r.substring(12).split(' ') : r.substring(10).split(' '))[0], component: parseInt(e[1], 10), protocol: e[2].toLowerCase(), priority: parseInt(e[3], 10), ip: e[4], address: e[4], port: parseInt(e[5], 10), type: e[7] }, a = 8; a < e.length; a += 2) switch (e[a]) {
        case 'raddr':
    ...
    }, r.writeIceParameters = function(r) { return 'a=ice-ufrag:' + r.usernameFragment + '\r\na=ice-pwd:' + r.password + '\r\n'; }, r.parseRtpParameters = function(e) {
      ...
      var a = '';
      a += 'm=' + e + ' ', a += t.codecs.length > 0 ? '9' : '0', a += ' UDP/TLS/RTP/SAVPF ', a += t.codecs.map(function(r) { return void 0 !== r.preferredPayloadType ? r.preferredPayloadType : r.payloadType; }).join(' ') + '\r\n', a += 'c=IN IP4 0.0.0.0\r\n', a += 'a=rtcp:9 IN IP4 0.0.0.0\r\n', t.codecs.forEach(function(e) { a += r.writeRtpMap(e), a += r.writeFmtp(e), a += r.writeRtcpFb(e); });
      var n = 0;
      return t.codecs.forEach(function(r) { r.maxptime > n && (n = r.maxptime); }), n > 0 && (a += 'a=maxptime:' + n + '\r\n'), a += 'a=rtcp-mux\r\n', t.headerExtensions && t.headerExtensions.forEach(function(e) { a += r.writeExtmap(e); }), a;
      ...
      return u.length && (u = 0 === u[0].indexOf('b=TIAS:') ? parseInt(u[0].substr(7), 10) : 0 === u[0].indexOf('b=AS:') ? 1e3 * parseInt(u[0].substr(5), 10) * .95 - 16e3 : void 0, a.forEach(function(r) { r.maxBitrate = u; })), a;
    }, r.parseRtcpParameters = function(e) {
      var t = {},
        a = r.matchPrefix(e, 'a=ssrc:').map(function(e) { return r.parseSsrcMedia(e); }).filter(function(r) { return 'cname' === r.attribute; })[0];
    ...
    }, r.parseMsid = function(e) { var t, a = r.matchPrefix(e, 'a=msid:'); if (1 === a.length) return { stream: (t = a[0].substr(7).split(' '))[0], track: t[1] }; var n = r.matchPrefix(e, 'a=ssrc:').map(function(e) { return r.parseSsrcMedia(e); }).filter(function(r) { return 'msid' === r.attribute; }); return n.length > 0 ? { stream: (t = n[0].value.split(' '))[0], track: t[1] } : void 0; }, r.parseSctpDescription = function(e) {
      var t, a = r.parseMLine(e),
  ...
  'Fzdr': [function(require, module, exports) {
    ...
    function s(e) { 'object' === a(e) && e.RTCTrackEvent && 'receiver' in e.RTCTrackEvent.prototype && !('transceiver' in e.RTCTrackEvent.prototype) && Object.defineProperty(e.RTCTrackEvent.prototype, 'transceiver', { get: function() { return { receiver: this.receiver }; } }); }
      ...
      if ('object' === a(e) && (e.RTCPeerConnection || e.mozRTCPeerConnection)) {
        !e.RTCPeerConnection && e.mozRTCPeerConnection && (e.RTCPeerConnection = e.mozRTCPeerConnection), t.version < 53 && ['setLocalDescription', 'setRemoteDescription', 'addIceCandidate'].forEach(function(t) {
          var n = e.RTCPeerConnection.prototype[t],
            r = i({}, t, function() { return arguments[0] = new('addIceCandidate' === t ? e.RTCIceCandidate : e.RTCSessionDescription)(arguments[0]), n.apply(this, arguments); });
        ...
        e.RTCPeerConnection.prototype.getStats = function() {
          ...
          return r.apply(this, [e || null]).then(function(e) {
            if (t.version < 53 && !o) try { e.forEach(function(e) { e.type = n[e.type] || e.type; }); } catch (r) {
              if ('TypeError' !== r.name) throw r;
              e.forEach(function(t, r) { e.set(r, Object.assign({}, t, { type: n[t.type] || t.type })); });
            }
            return e;
          }).then(o, i);
        };
    ...
    function p(e) {
      if ('object' === a(e) && e.RTCPeerConnection && e.RTCRtpSender && !(e.RTCRtpSender && 'getStats' in e.RTCRtpSender.prototype)) {
        ...
        n && (e.RTCPeerConnection.prototype.addTrack = function() { var e = n.apply(this, arguments); return e._pc = this, e; }), e.RTCRtpSender.prototype.getStats = function() { return this.track ? this._pc.getStats(this.track) : Promise.resolve(new Map); };
      }
    }
    ...
    function f(t) {
      !t.RTCPeerConnection || 'removeStream' in t.RTCPeerConnection.prototype || (t.RTCPeerConnection.prototype.removeStream = function(t) {
        var n = this;
        e.deprecated('removeStream', 'removeTrack'), this.getSenders().forEach(function(e) { e.track && t.getTracks().includes(e.track) && n.removeTrack(e); });
      });
    }

    function d(e) { e.DataChannel && !e.RTCDataChannel && (e.RTCDataChannel = e.DataChannel); }
    ...
    function C(e) {
      if ('object' === a(e) && e.RTCPeerConnection) {
        ...
        t && (e.RTCPeerConnection.prototype.addTransceiver = function() {
          ...
          n && e.sendEncodings.forEach(function(e) { if ('rid' in e) { if (!/^[a-z0-9]{0,16}$/i.test(e.rid)) throw new TypeError('Invalid RID value provided.'); } if ('scaleResolutionDownBy' in e && !(parseFloat(e.scaleResolutionDownBy) >= 1)) throw new RangeError('scale_resolution_down_by must be >= 1.0'); if ('maxFramerate' in e && !(parseFloat(e.maxFramerate) >= 0)) throw new RangeError('max_framerate must be >= 0.0'); });
          var r = t.apply(this, arguments);
          if (n) { var { sender: o } = r, i = o.getParameters(); 'encodings' in i && (1 !== i.encodings.length || 0 !== Object.keys(i.encodings[0]).length) || (i.encodings = e.sendEncodings, o.sendEncodings = e.sendEncodings, this.setParametersPromises.push(o.setParameters(i).then(function() { delete o.sendEncodings; }).catch(function() { delete o.sendEncodings; }))); }
          return r;
        });
      }
    }
    ...
    function y(e) {
      if ('object' === a(e) && e.RTCRtpSender) {
        ...
        t && (e.RTCRtpSender.prototype.getParameters = function() { var e = t.apply(this, arguments); return 'encodings' in e || (e.encodings = [].concat(this.sendEncodings || [{}])), e; });
      }
    }
    ...
    function l(e) {
      if ('object' === a(e) && e.RTCPeerConnection) {
        ...
        e.RTCPeerConnection.prototype.createOffer = function() {
          var e = arguments,
            n = this;
          return this.setParametersPromises && this.setParametersPromises.length ? Promise.all(this.setParametersPromises).then(function() { return t.apply(n, e); }).finally(function() { n.setParametersPromises = []; }) : t.apply(this, arguments);
        };
      }
    }
  ...
  't1lL': [function(require, module, exports) {
    ...
    function n(e) {
      if ('object' === o(e) && e.RTCPeerConnection) {
        if ('getLocalStreams' in e.RTCPeerConnection.prototype || (e.RTCPeerConnection.prototype.getLocalStreams = function() { return this._localStreams || (this._localStreams = []), this._localStreams; }), !('addStream' in e.RTCPeerConnection.prototype)) {
          ...
          }, e.RTCPeerConnection.prototype.addTrack = function(e) { for (var r = this, o = arguments.length, n = new Array(o > 1 ? o - 1 : 0), i = 1; i < o; i++) n[i - 1] = arguments[i]; return n && n.forEach(function(e) { r._localStreams ? r._localStreams.includes(e) || r._localStreams.push(e) : r._localStreams = [e]; }), t.apply(this, arguments); };
        }
    ...
    function a(e) {
      if ('object' === o(e) && e.RTCPeerConnection) {
        ...
        var s = function(e, t, r) { var o = i.apply(this, [e]); return r ? (o.then(t, r), Promise.resolve()) : o; };
        t.setLocalDescription = s, s = function(e, t, r) { var o = a.apply(this, [e]); return r ? (o.then(t, r), Promise.resolve()) : o; }, t.setRemoteDescription = s, s = function(e, t, r) { var o = c.apply(this, [e]); return r ? (o.then(t, r), Promise.resolve()) : o; }, t.addIceCandidate = s;
      }
    }
    ...
    function c(e) {
      ...
      if (t.mediaDevices && t.mediaDevices.getUserMedia) {
        ...
        t.mediaDevices.getUserMedia = function(e) { return o(s(e)); };
    ...
    function s(t) { return t && void 0 !== t.video ? Object.assign({}, t, { video: e.compactObject(t.video) }) : t; }
    ...
    function d(t) {
      if (t.RTCPeerConnection) {
        ...
        t.RTCPeerConnection = function(t, o) {
          ...
          return new r(t, o);
        }, t.RTCPeerConnection.prototype = r.prototype, 'generateCertificate' in r && Object.defineProperty(t.RTCPeerConnection, 'generateCertificate', { get: function() { return r.generateCertificate; } });
      }
    }
    ...
    function u(e) { 'object' !== o(e) || e.AudioContext || (e.AudioContext = e.webkitAudioContext); }
  }, { '../utils': 'iSxC' }],
  'GOQK': [function(require, module, exports) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.shimRTCIceCandidate = a, exports.shimMaxMessageSize = c, exports.shimSendThrowTypeError = s, exports.shimConnectionState = p, exports.removeExtmapAllowMixed = d, exports.shimAddIceCandidateNullOrEmpty = u;
    var e = r(require('sdp')),
      t = o(require('./utils'));
    ...
    function c(t, n) {
      if (t.RTCPeerConnection) {
        'sctp' in t.RTCPeerConnection.prototype || Object.defineProperty(t.RTCPeerConnection.prototype, 'sctp', { get: function() { return void 0 === this._sctp ? null : this._sctp; } });
        var o = t.RTCPeerConnection.prototype.setRemoteDescription;
        t.RTCPeerConnection.prototype.setRemoteDescription = function() {
          if (this._sctp = null, 'chrome' === n.browser && n.version >= 76) { var { sdpSemantics: t } = this.getConfiguration(); 'plan-b' === t && Object.defineProperty(this, 'sctp', { get: function() { return void 0 === this._sctp ? null : this._sctp; }, enumerable: !0, configurable: !0 }); }
          if (function(t) { if (!t || !t.sdp) return !1; var n = e.default.splitSections(t.sdp); return n.shift(), n.some(function(t) { var n = e.default.parseMLine(t); return n && 'application' === n.kind && -1 !== n.protocol.indexOf('SCTP'); }); }(arguments[0])) {
            var r, i = function(e) { var t = e.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/); if (null === t || t.length < 2) return -1; var n = parseInt(t[1], 10); return n != n ? -1 : n; }(arguments[0]),
              a = (p = i, d = 65536, 'firefox' === n.browser && (d = n.version < 57 ? -1 === p ? 16384 : 2147483637 : n.version < 60 ? 57 === n.version ? 65535 : 65536 : 2147483637), d),
              c = function(t, o) { var r = 65536; 'firefox' === n.browser && 57 === n.version && (r = 65535); var i = e.default.matchPrefix(t.sdp, 'a=max-message-size:'); return i.length > 0 ? r = parseInt(i[0].substr(19), 10) : 'firefox' === n.browser && -1 !== o && (r = 2147483637), r; }(arguments[0], i);
            r = 0 === a && 0 === c ? Number.POSITIVE_INFINITY : 0 === a || 0 === c ? Math.max(a, c) : Math.min(a, c);
            var s = {};
            Object.defineProperty(s, 'maxMessageSize', { get: function() { return r; } }), this._sctp = s;
          }
          var p, d;
      ...
      if (e.RTCPeerConnection && !('chrome' === t.browser && t.version >= 71 || 'safari' === t.browser && t.version >= 605)) {
        ...
        e.RTCPeerConnection.prototype.setRemoteDescription = function(t) {
          if (t && t.sdp && -1 !== t.sdp.indexOf('\na=extmap-allow-mixed')) {
            ...
            e.RTCSessionDescription && t instanceof e.RTCSessionDescription ? arguments[0] = new e.RTCSessionDescription({ type: t.type, sdp: o }) : t.sdp = o;
          }
    ...
    function u(e, t) {
      if (e.RTCPeerConnection && e.RTCPeerConnection.prototype) {
        ...
        n && 0 !== n.length && (e.RTCPeerConnection.prototype.addIceCandidate = function() { return arguments[0] ? ('chrome' === t.browser && t.version < 78 || 'firefox' === t.browser && t.version < 68 || 'safari' === t.browser) && arguments[0] && '' === arguments[0].candidate ? Promise.resolve() : n.apply(this, arguments) : (arguments[1] && arguments[1].apply(null), Promise.resolve()); });
      }
    }
  }, { 'sdp': 'YHvh', './utils': 'iSxC' }],
  'KtlG': [function(require, module, exports) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.adapterFactory = o;
    ...
    function o() {
      var { window: n } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, m = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { shimChrome: !0, shimFirefox: !0, shimEdge: !0, shimSafari: !0 }, o = e.log, h = e.detectBrowser(n), d = { browserDetails: h, commonShim: a, extractVersion: e.extractVersion, disableLog: e.disableLog, disableWarnings: e.disableWarnings };
      switch (h.browser) {
        case 'chrome':
  ...
  'tI1X': [function(require, module, exports) {
    ...
    var e = require('./adapter_factory.js'),
      t = (0, e.adapterFactory)({ window: 'undefined' == typeof window ? void 0 : window }),
      d = t;
    exports.default = d;
  ...
  'sXtV': [function(require, module, exports) {
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.webRTCAdapter = void 0;
    var t = e(require('webrtc-adapter'));
    exports.webRTCAdapter = t.default;
  }, { 'webrtc-adapter': 'tI1X' }],
  'I31f': [function(require, module, exports) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.Supports = void 0;
  ...
  'BHXf': [function(require, module, exports) {
    'use strict';
    var e = this && this.__createBinding || (Object.create ? function(e, t, r, o) { void 0 === o && (o = r), Object.defineProperty(e, o, { enumerable: !0, get: function() { return t[r]; } }); } : function(e, t, r, o) { void 0 === o && (o = r), e[o] = t[r]; }),
      t = this && this.__setModuleDefault || (Object.create ? function(e, t) { Object.defineProperty(e, 'default', { enumerable: !0, value: t }); } : function(e, t) { e.default = t; }),
      r = this && this.__importStar || function(r) {
        if (r && r.__esModule) return r;
        var o = {};
        if (null != r)
          for (var n in r) 'default' !== n && Object.prototype.hasOwnProperty.call(r, n) && e(o, r, n);
        return t(o, r), o;
      };
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.util = void 0;
    var o = r(require('peerjs-js-binarypack')),
      n = require('./supports'),
      i = { iceServers: [{ urls: 'stun:stun.l.google.com:19302' }, { urls: 'turn:0.peerjs.com:3478', username: 'peerjs', credential: 'peerjsp' }], sdpSemantics: 'unified-plan' };
    exports.util = new(function() {
      function e() { this.CLOUD_HOST = '0.peerjs.com', this.CLOUD_PORT = 443, this.chunkedBrowsers = { Chrome: 1, chrome: 1 }, this.chunkedMTU = 16300, this.defaultConfig = i, this.browser = n.Supports.getBrowser(), this.browserVersion = n.Supports.getVersion(), this.supports = function() { var e, t = { browser: n.Supports.isBrowserSupported(), webRTC: n.Supports.isWebRTCSupported(), audioVideo: !1, data: !1, binaryBlob: !1, reliable: !1 }; if (!t.webRTC) return t; try { e = new RTCPeerConnection(i), t.audioVideo = !0; var r = void 0; try { r = e.createDataChannel('_PEERJSTEST', { ordered: !0 }), t.data = !0, t.reliable = !!r.ordered; try { r.binaryType = 'blob', t.binaryBlob = !n.Supports.isIOS; } catch (o) {} } catch (o) {} finally { r && r.close(); } } catch (o) {} finally { e && e.close(); } return t; }(), this.pack = o.pack, this.unpack = o.unpack, this._dataCount = 1; }
      return e.prototype.noop = function() {}, e.prototype.validateId = function(e) { return !e || /^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e); }, e.prototype.chunk = function(e) {
  ...
  'WOs9': [function(require, module, exports) {
    ...
    var r = this && this.__read || function(r, e) {
      ...
      e = this && this.__spreadArray || function(r, e) { for (var o = 0, t = e.length, n = r.length; o < t; o++, n++) r[n] = e[o]; return r; };
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.LogLevel = void 0;
    var o, t = 'PeerJS: ';
    ...
    var n = function() {
      function n() { this._logLevel = o.Disabled; }
      return Object.defineProperty(n.prototype, 'logLevel', { get: function() { return this._logLevel; }, set: function(r) { this._logLevel = r; }, enumerable: !1, configurable: !0 }), n.prototype.log = function() {
        for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
        this._logLevel >= o.All && this._print.apply(this, e([o.All], r(t)));
      }, n.prototype.warn = function() {
        for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
        this._logLevel >= o.Warnings && this._print.apply(this, e([o.Warnings], r(t)));
      }, n.prototype.error = function() {
        for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
        this._logLevel >= o.Errors && this._print.apply(this, e([o.Errors], r(t)));
      }, n.prototype.setLogFunction = function(r) { this._print = r; }, n.prototype._print = function(n) {
        for (var l = [], i = 1; i < arguments.length; i++) l[i - 1] = arguments[i];
        var s = e([t], r(l));
        for (var a in s) s[a] instanceof Error && (s[a] = '(' + s[a].name + ') ' + s[a].message);
        n >= o.All ? console.log.apply(console, e([], r(s))) : n >= o.Warnings ? console.warn.apply(console, e(['WARNING'], r(s))) : n >= o.Errors && console.error.apply(console, e(['ERROR'], r(s)));
      }, n;
    }();
  ...
  'ZRYf': [function(require, module, exports) {
    'use strict';
    var e, r, o, n, t, a, i;
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.ServerMessageType = exports.SocketEventType = exports.SerializationType = exports.PeerErrorType = exports.PeerEventType = exports.ConnectionType = exports.ConnectionEventType = void 0,
      ...
      function(e) { e.Open = 'open', e.Close = 'close', e.Connection = 'connection', e.Call = 'call', e.Disconnected = 'disconnected', e.Error = 'error'; }(o = exports.PeerEventType || (exports.PeerEventType = {})),
      function(e) { e.BrowserIncompatible = 'browser-incompatible', e.Disconnected = 'disconnected', e.InvalidID = 'invalid-id', e.InvalidKey = 'invalid-key', e.Network = 'network', e.PeerUnavailable = 'peer-unavailable', e.SslUnavailable = 'ssl-unavailable', e.ServerError = 'server-error', e.SocketError = 'socket-error', e.SocketClosed = 'socket-closed', e.UnavailableID = 'unavailable-id', e.WebRTC = 'webrtc'; }(n = exports.PeerErrorType || (exports.PeerErrorType = {})),
  ...
  'wJlv': [function(require, module, exports) {
    ...
    var e = this && this.__extends || function() {
        var e = function(t, n) {
          return (e = Object.setPrototypeOf || { __proto__: [] }
            instanceof Array && function(e, t) { e.__proto__ = t; } || function(e, t) { for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]); })(t, n);
        };
        return function(t, n) {
      ...
      t = this && this.__read || function(e, t) {
        ...
        try {
          for (;
            (void 0 === t || t-- > 0) && !(o = r.next()).done;) i.push(o.value);
        } catch (c) { s = { error: c }; } finally { try { o && !o.done && (n = r.return) && n.call(r); } finally { if (s) throw s.error; } }
        return i;
      },
      n = this && this.__spreadArray || function(e, t) { for (var n = 0, o = t.length, s = e.length; n < o; n++, s++) e[s] = t[n]; return e; },
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.Socket = void 0;
      ...
      a = function(s) {
        ...
        return e(r, s), r.prototype.start = function(e, t) {
          ...
          !this._socket && this._disconnected && (this._socket = new WebSocket(o), this._disconnected = !1, this._socket.onmessage = function(e) {
            var t;
            try { t = JSON.parse(e.data), i.default.log('Server message received:', t); } catch (o) { return void i.default.log('Invalid server message', e.data); }
        ...
        }, r.prototype._wsOpen = function() { return !!this._socket && 1 === this._socket.readyState; }, r.prototype._sendQueuedMessages = function() {
          ...
          } catch (u) { e = { error: u }; } finally { try { c && !c.done && (s = i.return) && s.call(i); } finally { if (e) throw e.error; } }
        ...
        }, r.prototype.close = function() { this._disconnected || (this._cleanup(), this._disconnected = !0); }, r.prototype._cleanup = function() { this._socket && (this._socket.onopen = this._socket.onmessage = this._socket.onclose = null, this._socket.close(), this._socket = void 0), clearTimeout(this._wsPingTimer); }, r;
      }(r.EventEmitter);
    exports.Socket = a;
  ...
  'HCdX': [function(require, module, exports) {
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.Negotiator = void 0;
    var i = require('./util'),
      r = o(require('./logger')),
      c = require('./enums'),
      a = function() {
  ...
  'tQFK': [function(require, module, exports) {
    ...
    var t = this && this.__extends || function() {
      var t = function(e, n) {
        return (t = Object.setPrototypeOf || { __proto__: [] }
          instanceof Array && function(t, e) { t.__proto__ = e; } || function(t, e) { for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]); })(e, n);
      };
      return function(e, n) {
        if ('function' != typeof n && null !== n) throw new TypeError('Class extends value ' + String(n) + ' is not a constructor or null');
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.BaseConnection = void 0;
    var e = require('eventemitter3'),
      n = function(e) {
        function n(t, n, o) { var r = e.call(this) || this; return r.peer = t, r.provider = n, r.options = o, r._open = !1, r.metadata = o.metadata, r; }
        return t(n, e), Object.defineProperty(n.prototype, 'open', { get: function() { return this._open; }, enumerable: !1, configurable: !0 }), n;
      }(e.EventEmitter);
  ...
  'dbHP': [function(require, module, exports) {
    ...
    var e = this && this.__extends || function() {
        var e = function(t, o) {
          return (e = Object.setPrototypeOf || { __proto__: [] }
            instanceof Array && function(e, t) { e.__proto__ = t; } || function(e, t) { for (var o in t) Object.prototype.hasOwnProperty.call(t, o) && (e[o] = t[o]); })(t, o);
        };
        return function(t, o) {
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.MediaConnection = void 0;
    var n = require('./util'),
      i = r(require('./logger')),
  ...
  'GGp6': [function(require, module, exports) {
    ...
    var e = this && this.__extends || function() {
        var e = function(t, r) {
          return (e = Object.setPrototypeOf || { __proto__: [] }
            instanceof Array && function(e, t) { e.__proto__ = t; } || function(e, t) { for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && (e[r] = t[r]); })(t, r);
        };
        return function(t, r) {
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.EncodingQueue = void 0;
    var r = require('eventemitter3'),
      o = t(require('./logger')),
      n = function(t) {
        ...
        return e(r, t), Object.defineProperty(r.prototype, 'queue', { get: function() { return this._queue; }, enumerable: !1, configurable: !0 }), Object.defineProperty(r.prototype, 'size', { get: function() { return this.queue.length; }, enumerable: !1, configurable: !0 }), Object.defineProperty(r.prototype, 'processing', { get: function() { return this._processing; }, enumerable: !1, configurable: !0 }), r.prototype.enque = function(e) { this.queue.push(e), this.processing || this.doNextTask(); }, r.prototype.destroy = function() { this.fileReader.abort(), this._queue = []; }, r.prototype.doNextTask = function() { 0 !== this.size && (this.processing || (this._processing = !0, this.fileReader.readAsArrayBuffer(this.queue.shift()))); }, r;
      }(r.EventEmitter);
  ...
  'GBTQ': [function(require, module, exports) {
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.DataConnection = void 0;
    var i = require('./util'),
      o = n(require('./logger')),
  ...
  'in7L': [function(require, module, exports) {
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.API = void 0;
    var o = require('./util'),
      n = r(require('./logger')),
      s = function() {
  ...
  'Hxpd': [function(require, module, exports) {
    ...
    var e = this && this.__extends || function() {
      ...
      o = this && this.__importDefault || function(e) { return e && e.__esModule ? e : { default: e }; };
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.Peer = void 0;
    var i = require('eventemitter3'),
      ...
      f = function(o) {
        function i(e, n) { var r, c = o.call(this) || this; return c._id = null, c._lastServerId = null, c._destroyed = !1, c._disconnected = !1, c._open = !1, c._connections = new Map, c._lostMessages = new Map, e && e.constructor == Object ? n = e : e && (r = e.toString()), n = t({ debug: 0, host: s.util.CLOUD_HOST, port: s.util.CLOUD_PORT, path: '/', key: i.DEFAULT_KEY, token: s.util.randomToken(), config: s.util.defaultConfig }, n), c._options = n, '/' === c._options.host && (c._options.host = window.location.hostname), c._options.path && ('/' !== c._options.path[0] && (c._options.path = '/' + c._options.path), '/' !== c._options.path[c._options.path.length - 1] && (c._options.path += '/')), void 0 === c._options.secure && c._options.host !== s.util.CLOUD_HOST ? c._options.secure = s.util.isSecure() : c._options.host == s.util.CLOUD_HOST && (c._options.secure = !0), c._options.logFunction && a.default.setLogFunction(c._options.logFunction), a.default.logLevel = c._options.debug || 0, c._api = new p.API(n), c._socket = c._createServerConnection(), s.util.supports.audioVideo || s.util.supports.data ? r && !s.util.validateId(r) ? (c._delayedAbort(d.PeerErrorType.InvalidID, 'ID "' + r + '" is invalid'), c) : (r ? c._initialize(r) : c._api.retrieveId().then(function(e) { return c._initialize(e); }).catch(function(e) { return c._abort(d.PeerErrorType.ServerError, e); }), c) : (c._delayedAbort(d.PeerErrorType.BrowserIncompatible, 'The current browser does not support WebRTC'), c); }
        return e(i, o), Object.defineProperty(i.prototype, 'id', { get: function() { return this._id; }, enumerable: !1, configurable: !0 }), Object.defineProperty(i.prototype, 'options', { get: function() { return this._options; }, enumerable: !1, configurable: !0 }), Object.defineProperty(i.prototype, 'open', { get: function() { return this._open; }, enumerable: !1, configurable: !0 }), Object.defineProperty(i.prototype, 'socket', { get: function() { return this._socket; }, enumerable: !1, configurable: !0 }), Object.defineProperty(i.prototype, 'connections', {
          get: function() {
            ...
            } catch (u) { e = { error: u }; } finally { try { s && !s.done && (t = i.return) && t.call(i); } finally { if (e) throw e.error; } }
            return o;
          },
          enumerable: !1,
          configurable: !0,
        }), Object.defineProperty(i.prototype, 'destroyed', { get: function() { return this._destroyed; }, enumerable: !1, configurable: !0 }), Object.defineProperty(i.prototype, 'disconnected', { get: function() { return this._disconnected; }, enumerable: !1, configurable: !0 }), i.prototype._createServerConnection = function() {
          var e = this,
          ...
          return t.on(d.SocketEventType.Message, function(t) { e._handleMessage(t); }), t.on(d.SocketEventType.Error, function(t) { e._abort(d.PeerErrorType.SocketError, t); }), t.on(d.SocketEventType.Disconnected, function() { e.disconnected || (e.emitError(d.PeerErrorType.Network, 'Lost connection to server.'), e.disconnect()); }), t.on(d.SocketEventType.Close, function() { e.disconnected || e._abort(d.PeerErrorType.SocketClosed, 'Underlying socket is already closed.'); }), t;
          ...
          switch (o) {
            ...
            case d.ServerMessageType.Offer:
              ...
              if ((_ = this.getConnection(s, c)) && (_.close(), a.default.warn('Offer received for existing Connection ID:' + c)), i.type === d.ConnectionType.Media) _ = new l.MediaConnection(s, this, { connectionId: c, _payload: i, metadata: i.metadata }), this._addConnection(s, _), this.emit(d.PeerEventType.Call, _);
              else {
                if (i.type !== d.ConnectionType.Data) return void a.default.warn('Received malformed connection type:' + i.type);
                _ = new u.DataConnection(s, this, { connectionId: c, _payload: i, metadata: i.metadata, label: i.label, serialization: i.serialization, reliable: i.reliable }), this._addConnection(s, _), this.emit(d.PeerEventType.Connection, _);
              }
        ...
        }, i.prototype.destroy = function() { this.destroyed || (a.default.log('Destroy peer with ID:' + this.id), this.disconnect(), this._cleanup(), this._destroyed = !0, this.emit(d.PeerEventType.Close)); }, i.prototype._cleanup = function() {
          var e, t;
          try {
          ...
          var t = this;
          void 0 === e && (e = function(e) {}), this._api.listAllPeers().then(function(t) { return e(t); }).catch(function(e) { return t._abort(d.PeerErrorType.ServerError, e); });
  ...
  'iTK6': [function(require, module, exports) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: !0 }), exports.peerjs = void 0;
    var e = require('./util'),
      r = require('./peer');
